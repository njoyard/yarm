...
function applyOverrides(resourcePath, overrides, definition) {
	overrides.forEach(function(override) {
		if (override.regexp.exec(resourcePath)) {
			Object.keys(override.methods).forEach(function(method) {
				definition[method] = override.methods[method];
			});
		}
	});
...
function mongooseValueResource(urlpath, doc, path, options) {
	return applyOverrides(urlpath, options.overrides, {
		get: function(req, cb) {
...
function mongooseResource(name, model, options) {
	...
	resource(name, applyOverrides(name, options.overrides, {
		sub: function(id, cb) {
