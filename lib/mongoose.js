	...
	overrides.forEach(function(override) {
		if (override.regexp.exec(resourcePath)) {
			Object.keys(override.methods).forEach(function(method) {
				definition[method] = override.methods[method].bind(context);
			});
		}
	});
 ...
 *     }
 *
 * All methods overrides receive the current object (Model, Document,
 * DocumentArray or property value) as `this`.
 */
